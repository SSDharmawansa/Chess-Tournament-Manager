  ...
  static List<Tournament> seed() {
      ...
      Team(
        ...
        players: const [
          ...
          Player(
            ...
            rating: 2115,
            boardOrder: 3,
            ageCategory: AgeCategory.under18,
            gender: Gender.male,
            federation: 'SLCF',
            identificationNumber: 'SLC-003',
          ),
          Player(
            id: 'a4',
            name: 'Kavya Edirisinghe',
            rating: 2084,
            boardOrder: 4,
            ageCategory: AgeCategory.under16,
            gender: Gender.female,
            federation: 'SLCF',
            identificationNumber: 'SLC-004',
          ),
        ],
      ),
      Team(
        ...
        players: const [
          ...
          Player(
            ...
            gender: Gender.other,
            federation: 'SLCF',
            identificationNumber: 'MBA-002',
          ),
          Player(
            id: 'b3',
            name: 'Chathuni Amarasekara',
            rating: 2040,
            boardOrder: 3,
            ageCategory: AgeCategory.under18,
            gender: Gender.female,
            federation: 'SLCF',
            identificationNumber: 'MBA-003',
          ),
          Player(
            id: 'b4',
            name: 'Nevin Niroshan',
      ...
      Team(
        ...
        players: const [
          Player(
            ...
            gender: Gender.female,
            federation: 'SLCF',
            identificationNumber: 'GDL-001',
          ),
          Player(
            id: 'c2',
            name: 'Heshan Vithanage',
            rating: 2118,
            boardOrder: 2,
            ageCategory: AgeCategory.open,
            gender: Gender.male,
            federation: 'SLCF',
            identificationNumber: 'GDL-002',
          ),
          Player(
            id: 'c3',
            name: 'Piumi Tharaka',
            ...
            gender: Gender.female,
            federation: 'SLCF',
            identificationNumber: 'GDL-003',
          ),
          Player(
            id: 'c4',
            name: 'Yevan Rajapaksa',
            rating: 1966,
            boardOrder: 4,
            ageCategory: AgeCategory.under16,
            gender: Gender.male,
            federation: 'SLCF',
            identificationNumber: 'GDL-004',
          ),
        ],
      ),
      Team(
    ...
    return [
      Tournament(
        ...
        notes:
            'Sample tournament with seeded teams, board results, and standings.',
